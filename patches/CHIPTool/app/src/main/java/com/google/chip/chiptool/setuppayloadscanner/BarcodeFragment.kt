...
class BarcodeFragment : Fragment() {
  ...
  private fun startCamera() {
    ...
    binding.manualCodeHelpBtn.setOnClickListener {
      AlertDialog.Builder(requireContext())
        .setTitle("Code manuell eingeben")
        .setMessage(
          "Alternativ zum Scannen kann der Code des Geräts eingetippt werden:\n\n" +
            "• Aufgedruckter Zahlencode: ohne Bindestriche eingeben (z.B. 34970112332)\n\n" +
            "• Barcode-Inhalt: beginnend mit MT: (z.B. MT:YNJV7...)"
        )
